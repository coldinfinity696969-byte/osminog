...
NICHES = [
    {   # основная посадочная (корень)
        ...
        "lead": "Проектируем, дизайним и разрабатываем сайты под ключ — от лендинга до интернет-магазина<span class=\"lead-more\">: индивидуальный дизайн, адаптив под все устройства, готовность к рекламе и SEO</span>",
    ...
    {   # клиники / медцентры
        ...
        "lead": "Сайт медцентра с онлайн-записью, каталогом услуг и врачей и интеграцией с CRM<span class=\"lead-more\"> — удобно пациенту, выгодно клинике и сразу готово к рекламе</span>",
    ...
    {   # интернет-магазины
        ...
        "lead": "Каталог, корзина, онлайн-оплата и интеграция с 1С и маркетплейсами<span class=\"lead-more\"> — магазин, который удобно вести и который сам приносит заказы</span>",
